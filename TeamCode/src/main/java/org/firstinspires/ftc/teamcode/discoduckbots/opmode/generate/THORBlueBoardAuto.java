...
public class THORBlueBoardAuto extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        Trajectory trajectory_6_3 = drive.trajectoryBuilder(trajectory_6_2.end()).lineToLinearHeading( new Pose2d(35  ,42 ,4.69160740561243 ), velocityConstraint, accelerationConstraint).build();
