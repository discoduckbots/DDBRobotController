...
@Autonomous(name="forwardBlueAutoGoated", group="Robot")
public class ForwardBlueAutoGoated extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        TrajectoryAccelerationConstraint slowAccelerationConstraint =
                ...
                Pose2d RIGHT_OUTTAKE = new Pose2d(18.31, 6.8, Math.toRadians(0));
                ...
                Pose2d RIGHT_AWAY_FROM_BOARD = new Pose2d(18.59, 26.5, Math.toRadians(-90));
