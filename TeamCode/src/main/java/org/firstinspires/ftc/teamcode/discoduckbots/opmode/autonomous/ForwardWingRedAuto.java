...
@Autonomous(name="forwardWingRedAuto", group="Robot")
public class ForwardWingRedAuto extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        TrajectoryAccelerationConstraint slowAccelerationConstraint =
                ...
                Pose2d DUCK_POS = new Pose2d(30.18, 3.77, Math.toRadians(0));

                Pose2d LEFT_TO_BOARD = new Pose2d(34.41, -50, Math.toRadians(90));
                Pose2d LEFT_AWAY_FROM_BOARD = new Pose2d(34.58, -28.51, Math.toRadians(90));

                Pose2d MIDDLE_PUSH_DUCK = new Pose2d(32.15, 3.52, Math.toRadians(0));
                Pose2d MIDDLE_OUTTAKE = new Pose2d(25, 3.52, Math.toRadians(0));
                Pose2d MIDDLE_TO_BOARD = new Pose2d(27.51, -50, Math.toRadians(90));
                Pose2d MIDDLE_AWAY_FROM_BOARD = new Pose2d(27.51, -28.51, Math.toRadians(90));

                Pose2d RIGHT_OUTTAKE = new Pose2d(18.31, -6.83, Math.toRadians(0));
                Pose2d RIGHT_TO_BOARD = new Pose2d(18.59, -33.89, Math.toRadians(90));
                Pose2d RIGHT_AWAY_FROM_BOARD = new Pose2d(18.59, -28.51, Math.toRadians(90));
       ...
       //left pos 1
        Trajectory leftMoveToBoard = sampleMecanumDrive.trajectoryBuilder(driveToDuck.end().plus(new Pose2d(0, 0, Math.toRadians(90))))
        ...
        Trajectory middleToBoard = sampleMecanumDrive.trajectoryBuilder(middleOutake.end().plus(new Pose2d(0, 0, Math.toRadians(90))))
        ...
        Trajectory rightToBoard = sampleMecanumDrive.trajectoryBuilder(rightOutake.end().plus(new Pose2d(0, 0, Math.toRadians(90))))
